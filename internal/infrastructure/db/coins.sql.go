...
SELECT id, country, year, face_value, currency, material, description, km_code, min_value, max_value, grade, sample_image_url_front, sample_image_url_back, notes, gemini_details, group_id, user_notes, created_at, updated_at FROM coins
WHERE id = $1 LIMIT 1
`

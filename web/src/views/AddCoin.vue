        ...
        >
          ...
          <div v-else class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="relative group">
              ...
              <button @click.stop="removeFile('front')" class="btn btn-circle btn-xs btn-error absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity">✕</button>
            </div>
            ...
            <div class="relative group">
              ...
              <button @click.stop="removeFile('back')" class="btn btn-circle btn-xs btn-error absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity">✕</button>
            </div>
          </div>

          <!-- Swap Button -->
          <div v-if="frontFile && backFile" class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20">
             <button @click.stop="swapImages" class="btn btn-circle btn-primary shadow-lg tooltip" data-tip="Swap Front/Back">
